~ The Universal Basic Income Church ("TUBIC") is a private property of and in the Altruen Nation ~
...
4. The system will remain decentralized to avoid single points of failure and central control.
5. Rules may be amended by the King of TAN considering suggestions from OMT to improve an aspect of TAN's protocol.
...
Transactions are able to be signed either by a Member private key or the private key of an Identity Provider. This gives Identity Providers the ability to reverse transactions as UN authorized transactions of NMT are not permitted and all TXs of NMT are to reversed by TAN's AI.
